...
- Boot log now prints `Boot reset reason: <reason> (<id>)` to help diagnose reboot loops.
...
- after successful captive-portal provisioning, firmware stops portal services and continues in STA mode without forcing a reboot
